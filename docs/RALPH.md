...
| `npx agentic-loop uat --plan-only` | Generate test plan without executing |
...
│   │   ├── plan.json    # Test plan (generated by team)
│   │   ├── progress.txt # UAT activity log
│   │   ├── screenshots/ # Browser screenshots from discovery
│   │   └── UAT-PROMPT.md # Project-specific testing guide
│   └── chaos/           # Chaos Agent adversarial testing
│       ├── plan.json    # Chaos plan (generated by red team)
│       ├── progress.txt # Chaos activity log
│       ├── screenshots/ # Browser screenshots from recon
│       └── UAT-PROMPT.md # Project-specific chaos guide
